...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
               <h2><div class="card-header">{{ __('Register Tenant') }}</div></h2>
<br>
                <div class="card-body">
                    <form method="POST" action="{{ route('Register.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="idno" type="text" class="form-control{{ $errors->has('idno') ? ' is-invalid' : '' }}" name="idno" value="{{ old('idno') }}" required>
                        ...
                        <a class="btn btn-default" href="{{route('users.index')}}" role="button">Cancel</a>
